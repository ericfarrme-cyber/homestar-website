...
CONCEPTS = [
    ("01", "One contractor. One schedule. One warranty.", "Geist upper level", True,
     ...
     "The focal concept. Highest ticket in the set, and one accountable contractor across every trade is what makes the promise credible instead of a slogan.",
     "01-whole-home"),
    ...
    ("02", "Major projects, master craftsmanship", "Zionsville lower level", False,
     ...
     "Major Projects. Master Craftsmanship.", "Whole-home · Multi-room · Hamilton County",
     "Replaced the in-house-trades concept on 2026-09-06. The staffing argument asked a homeowner to care about an org chart; this one shows them four things a competitor has not built. Evidence rather than assertion, and every item traces to a real job in the portfolio.",
     "02-major-projects"),
