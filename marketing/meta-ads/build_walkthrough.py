...
FISHERS = {
    "slug": "F3-fishers-wetroom-fullai",
    ...
    "music": "stardust.m4a",
    "shots": [
        # Full AI pass: every one of the nine beats is generated motion.
        # All nine were frame-checked against their source at the last frame.
        #
        # The two mirror frames (03, 08) are the interesting ones. Zionsville's
        # wine room mirror hallucinated a photographer under a prompt that only
