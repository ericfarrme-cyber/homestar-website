...
const PROJECTS = [
  {
    ...
    cats: ["Whole Home"],
    color: "#3F4A54",
    desc: "A daylight lower level in Zionsville finished as a true entertaining floor — a full wet bar under soaring ceilings with a polished black stone countertop and full-height slab backsplash, a walk-in wine room built into the space beneath the stairs, a media lounge, and a full guest bathroom. Designed in collaboration with Holly Johnson. This is the first completed phase of a larger whole-home renovation.",
    ...
    designPartner: {name:"Holly Johnson", url:"https://www.hollyjohnsonrealestate.com", blurb:" — a central Indiana Realtor, stager and interior designer with more than 30 years in interior design and over 100 completed residential and commercial projects. HomeStar built to her drawings and finish schedule throughout."},
    images: [
