...
const SERVICE_PAGES = {
  ...
  "whole-home-renovation": {
    ...
    costIntro: "Multi-room and whole-home renovations with HomeStar run $50,000 to $300,000. Where a specific project lands depends on how many rooms are in scope and the finish level, and a multi-room project always costs less than the same rooms commissioned separately — shared demolition, one permitting cycle, one rough-in phase and one continuous flooring run. Here is how the scope tiers break down:",
    costs: [
      ...
      {level:"Main Level or Upper Level",range:"$100,000 – $200,000",desc:"Several rooms renovated as one project — for example a kitchen, two bathrooms and continuous flooring. Shared demolition, permitting, trade mobilization and finish work make this meaningfully less expensive than commissioning the same rooms separately."},
      {level:"Whole-Home Renovation",range:"$200,000 – $300,000",desc:"Every room in scope, planned as a single build and often delivered in phases. Our whole-home projects top out around $300,000. Above that the work is usually a custom build rather than a renovation, and we will tell you so."},
    ],
    ...
    faq: [
      ...
      {q:"How much does a whole-home renovation cost in Hamilton County, Indiana?",a:"Multi-room and whole-home renovations with HomeStar run $50,000 to $300,000. Two connected rooms — typically a kitchen opened into a living space — run $50,000 to $100,000. A full main level or upper level runs $100,000 to $200,000. A whole-home renovation runs $200,000 to $300,000. Where your project lands depends on how many rooms are in scope and the finish level, and doing rooms together always costs less than commissioning them separately because demolition, permitting, rough-in and flooring are shared."},
