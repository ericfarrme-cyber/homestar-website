...
const CITY_SVC_CONTENT = {
  ...
  "kitchen-remodeling-Zionsville":{
    quick:"Kitchen remodeling in Zionsville, Indiana typically costs $25,000 to $50,000 for a mid-range renovation, with cosmetic refreshes starting around $10,000 and full custom gut renovations running $50,000 to $80,000+. HomeStar is a licensed, full-service kitchen remodeler serving Zionsville with in-house design, licensed plumbers and electricians on every job, and a 1-year workmanship warranty.",
    body:["Zionsville pairs a walkable, historic brick-street village with upscale newer neighborhoods like Holliday Farms, Promontory, and Bradley Ridge — and the kitchens in these homes span everything from character-filled older layouts that need a smart modern reconfiguration to builder-grade kitchens in newer estates that are ready to be elevated. HomeStar approaches each one the same way: we start with how your family actually cooks, gathers, and entertains, then design a Zionsville kitchen around that reality.","The kitchen remodels Zionsville homeowners ask us for most are open-concept reconfigurations — removing a wall between the kitchen and living space, adding a large island for prep and seating, and upgrading to custom cabinetry with quartz or natural-stone countertops. Because kitchen work touches gas lines, water supply, drainage, and dedicated electrical circuits, every one of those trades on your project is handled by our own licensed plumbers and electricians rather than a rotating cast of subcontractors.","You'll see 3D renderings of your new Zionsville kitchen before demolition begins, so cabinet layout, counter runs, lighting, and finishes are all settled on paper first. Every project is managed directly by owners Eric and Robb and backed by our 1-year workmanship warranty — one accountable team from design through the final punch list."],
  },
  "kitchen-remodeling-Westfield":{
    quick:"Kitchen remodeling in Westfield, Indiana typically costs $25,000 to $50,000 for a mid-range renovation, with cosmetic updates starting near $10,000 and full custom renovations reaching $50,000 to $80,000+. HomeStar is a licensed, full-service kitchen remodeler serving Westfield with in-house design, licensed plumbers and electricians on every job, and a 1-year workmanship warranty.",
    body:["Westfield is one of the fastest-growing communities in Hamilton County, and neighborhoods like Chatham Hills, Bridgewater, Harmony, and Centennial are full of newer homes with kitchens finished to a builder's budget rather than the homeowner's taste. Most Westfield kitchen projects we take on are about elevating those spaces — swapping stock cabinetry for custom, upgrading laminate to quartz, and rethinking the island and lighting to match how the family really lives.","Because so many Westfield homes are open-concept, the kitchen sets the tone for the entire main floor, and homeowners here care about finishes that read as cohesive from the range to the great room. We help you choose cabinetry, countertops, backsplash tile, and flooring that work together and stand up to daily family use, then install them with licensed trades and finish carpentry that shows in the details.","Every Westfield kitchen starts with a 3D design so you can see the layout before a single cabinet is ordered, and all plumbing and electrical is completed by licensed professionals to keep the remodel on code and on schedule. You work directly with owners Eric and Robb from the first walkthrough to the final reveal, with our 1-year workmanship warranty behind the work."],
  },
  "kitchen-remodeling-Carmel":{
    quick:"Kitchen remodeling in Carmel, Indiana typically costs $25,000 to $50,000 for a mid-range renovation and $50,000 to $80,000+ for a full custom kitchen, with Carmel projects often landing at the higher end of those ranges. HomeStar is a licensed, full-service kitchen remodeler serving Carmel with in-house design, licensed plumbers and electricians on every job, and a 1-year workmanship warranty.",
    body:["Carmel consistently ranks among the best places to live in America, and its kitchens are held to that standard — from the estates of Bridgewater Club and the Village of WestClay to the neighborhoods around Jackson's Grant, Springmill, and City Center. Carmel kitchen remodels tend toward the higher end: full custom cabinetry, large islands with waterfall quartz or natural stone, designer lighting, integrated premium appliances, and layouts opened up for entertaining.","Because Carmel homeowners hold their homes to a premium standard, the details a lower bid cuts are exactly the ones that matter here — precise cabinetry runs, level counters, clean tile lines, and appliance integration that looks built-in rather than added on. We handle every trade in-house, with licensed plumbers for the sink, gas, and dishwasher lines and licensed electricians for dedicated circuits, under-cabinet LEDs, and pendant lighting.","Every Carmel kitchen begins with 3D renderings so the design is dialed in before demolition, and the entire build is managed directly by owners Eric and Robb with our 1-year workmanship warranty. The result is a kitchen finished to the caliber Carmel homes are known for — without the subcontractor roulette that so often derails high-end remodels."],
  },
};
