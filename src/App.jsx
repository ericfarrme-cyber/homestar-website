...
const SERVICE_PAGES = {
  ...
  "kitchen-remodeling": {
    ...
    costIntro: "Our minimum kitchen project is $25,000. Kitchen remodeling in Hamilton County typically runs $50,000 to $100,000 for a full remodel, with premium custom kitchens reaching $100,000+. Here's how the tiers break down for homeowners in Fishers, Carmel, Westfield, and Noblesville:",
    costs: [
      {level:"Cosmetic / Basic",range:"$25,000 – $50,000",desc:"The existing footprint stays. New countertops, cabinet refacing or new stock-to-semi-custom cabinetry, updated hardware, backsplash tile, sink and faucet, and a refreshed lighting package. Licensed plumbing and electrical, permits, and inspections are included at every tier — this is a fully permitted remodel, not a cosmetic patch."},
    ...
    projectCats: ["Kitchen"],
    faq: [
      {q:"How much does a kitchen remodel cost in Hamilton County, Indiana?",a:"Kitchen remodeling in Hamilton County starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel, with premium custom kitchens $100,000+. HomeStar's minimum kitchen project is $25,000. A Cosmetic/Basic remodel that keeps the existing footprint runs $25,000–$50,000, a Mid-Range/Full gut with new cabinetry and layout changes runs $50,000–$100,000, and a Premium Full custom kitchen runs $100,000+. Every tier includes licensed plumbing and electrical, permits, and inspections."},
      {q:"Why is there a $25,000 minimum on kitchen projects?",a:"Because we build kitchens as a licensed general contractor with permits, inspections, and our own licensed plumbers and electricians — not as a cosmetic refresh crew. Even the smallest kitchen we take on involves permitted plumbing and electrical work, cabinetry, countertops, tile, and finish carpentry. Below $25,000 you are buying a partial job with unlicensed trades, and that is not work we are willing to put our warranty behind."},
  ...
  "whole-home-renovation": {
    ...
    costs: [
      {level:"Two Connected Rooms",range:"$50,000 – $100,000",desc:"The most common starting point — typically a kitchen opened into a living space, or a kitchen plus a bathroom. Uses our published per-room pricing: bathrooms $15,000–$50,000+, kitchens from $25,000 (typically $50,000–$100,000), basements $45,000–$200,000+."},
...
const CITY_SVC_CONTENT = {
  ...
  "kitchen-remodeling-Westfield":{
    quick:"Kitchen remodeling in Westfield, Indiana starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel, with premium custom kitchens $100,000+. HomeStar is a licensed, full-service kitchen remodeler serving Westfield with in-house design, licensed plumbers and licensed electricians on every job, and a 1-year workmanship warranty.",
  ...
  "kitchen-remodeling-Carmel":{
    quick:"Kitchen remodeling in Carmel, Indiana starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel, with premium custom Carmel kitchens $100,000+. HomeStar is a licensed, full-service kitchen remodeler serving Carmel with in-house design, licensed plumbers and licensed electricians on every job, and a 1-year workmanship warranty.",
...
const GUIDES = {
  ...
  "kitchen-remodeling-hamilton-county":{
    ...
    sections:[
      {h:"Kitchen Remodel Costs in Hamilton County",p:["Kitchen remodeling in Hamilton County starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel, with premium custom kitchens $100,000+. HomeStar's minimum kitchen project is $25,000. A Cosmetic/Basic remodel that keeps the existing footprint — new cabinetry or refacing, countertops, backsplash, hardware, sink, and lighting — runs $25,000-$50,000. A Mid-Range/Full gut with new cabinetry, quartz or stone countertops, flooring, layout changes, and a designed lighting plan runs $50,000-$100,000. A Premium Full custom kitchen with full custom cabinetry, premium stone, integrated high-end appliances, and structural changes runs $100,000+.","Every tier includes licensed plumbing and electrical, permits, and inspections. Kitchens are the most plumbing- and electrical-heavy room in a house, and that work is not optional or cosmetic — which is why our floor sits at $25,000 rather than at the sub-$20,000 figures national calculators quote for partial, unpermitted jobs."]},
    ...
    faq:[
      {q:"How much does a kitchen remodel cost in Hamilton County?",a:"Kitchen remodeling in Hamilton County starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel, with premium custom kitchens $100,000+. Cosmetic/Basic remodels keeping the existing footprint run $25,000-$50,000, Mid-Range/Full gut remodels with layout changes run $50,000-$100,000, and Premium Full custom kitchens run $100,000+."},
  ...
  "kitchen-remodeling-cost-report-2026":{
    ...
    sections:[
      {h:"2026 Kitchen Remodeling Cost Summary for Hamilton County",p:["Kitchen remodeling in Hamilton County, Indiana starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel in 2026, with premium custom kitchens $100,000+. HomeStar's minimum kitchen project is $25,000.","Pricing breaks into three tiers: Cosmetic/Basic ($25,000–$50,000), Mid-Range/Full ($50,000–$100,000), and Premium Full ($100,000+). The factors that move a project between tiers are whether the layout changes, cabinetry grade, countertop material, whether a wall is removed, and how far finishes carry into connected rooms.","Every tier includes licensed plumbing and electrical, permits, and inspections. This is the central reason our floor sits at $25,000 while national averages quote lower: those averages describe cosmetic work performed without permits or licensed trades, which is a different product rather than a cheaper version of the same one."]},
      {h:"Cost by Tier: What Each Level Includes",p:["Cosmetic/Basic: $25,000–$50,000. The existing footprint is retained. Includes new countertops, cabinet refacing or new stock-to-semi-custom cabinetry, updated hardware, backsplash tile, new sink and faucet, and a refreshed lighting package — all with licensed trades, permits, and inspections. Appropriate when the layout already works and the surfaces have aged out.","Mid-Range/Full: $50,000–$100,000. The most common tier in Hamilton County. A full gut with new cabinetry, quartz or natural-stone countertops, new flooring, backsplash, and a designed three-layer lighting plan, plus layout changes — island additions, sink or range relocation, and reworked appliance runs. Wall removal between the kitchen and an adjacent living space typically falls in this tier.","Premium Full: $100,000+. Full custom cabinetry, premium stone with waterfall edges, integrated high-end appliances, designer lighting, structural changes, and finish carpentry throughout. Kitchens at this level are frequently the anchor of a larger multi-room renovation encompassing the hearth room, butler's pantry, and mudroom in a single phase. Most common in Carmel, Zionsville (Holliday Farms, Promontory), and Westfield (Chatham Hills)."]},
    ...
    faq:[
      {q:"What is the average cost of a kitchen remodel in Hamilton County in 2026?",a:"Kitchen remodeling in Hamilton County starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel in 2026, with premium custom kitchens $100,000+. Cosmetic/Basic remodels retaining the existing footprint run $25,000–$50,000, Mid-Range/Full gut remodels with layout changes run $50,000–$100,000, and Premium Full custom kitchens run $100,000+."},
      {q:"Why do kitchen remodels have a $25,000 minimum?",a:"Because a kitchen is the most plumbing- and electrical-heavy room in a house. Even a modest remodel involves water supply and drainage, gas lines, dedicated appliance circuits, lighting, and range hood venting — all requiring licensed trades, permits, and inspections. Figures below $25,000 typically describe unpermitted cosmetic work using general laborers rather than licensed professionals."},
...
function KitchenCostCalculator(){
  ...
  const calcFaq=[
    {q:"How much does a kitchen remodel cost in Hamilton County?",a:"Kitchen remodeling in Hamilton County starts at $25,000 and typically runs $50,000 to $100,000 for a full remodel, with premium custom kitchens $100,000+. A Cosmetic/Basic remodel keeping the existing footprint runs $25,000–$50,000, a Mid-Range/Full gut with layout changes runs $50,000–$100,000, and a Premium Full custom kitchen runs $100,000+. Use the calculator above to estimate your specific project."},
    {q:"Why is there a $25,000 minimum on kitchen projects?",a:"A kitchen is the most plumbing- and electrical-heavy room in a house. Even a modest remodel involves supply and drainage, gas lines, dedicated appliance circuits, lighting, and venting — all requiring licensed trades, permits, and inspections. Figures below $25,000 typically describe unpermitted cosmetic work performed by general laborers rather than licensed professionals."},
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:32}} className="hero-grid">
            ...
            <div>
              <div style={{position:"sticky",top:100,borderRadius:16,overflow:"hidden",border:`1px solid ${C.sand}`,background:`linear-gradient(145deg,${C.navyDark},${C.navy})`}}>
                ...
                <div style={{padding:"18px 28px 28px"}}>
                  <a href="/#estimate" className="btn-g" style={{display:"block",textAlign:"center",width:"100%",boxSizing:"border-box"}}>Get My Exact Quote {I.arrow}</a>
                  <p style={{color:"rgba(255,255,255,.4)",fontSize:11.5,lineHeight:1.5,marginTop:14,textAlign:"center"}}>Planning estimate based on HomeStar's real Hamilton County pricing. Our minimum kitchen project is $25,000. Permits ($200–$500) handled by us. Final cost confirmed with a free in-home consultation.</p>
                </div>
              </div>
            </div>
          </div>
...
function CostCalculator(){
  ...
  const scopeDescs={
    ...
    kitchen:{basic:"Cosmetic/Basic — existing footprint kept. New countertops, cabinetry or refacing, backsplash, hardware, sink, lighting. Permitted, licensed trades. $25,000 minimum.",mid:"Mid-Range/Full — full gut with new cabinetry, quartz or stone counters, flooring, layout changes, island additions, designed lighting.",high:"Premium Full — full custom cabinetry, premium stone, integrated high-end appliances, structural changes, designer lighting and finish carpentry."},
