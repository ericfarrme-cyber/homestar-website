...
function NeighborhoodPage({hood}){
  ...
  return(
    <div style={{overflowX:"hidden"}}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"HomeAndConstructionBusiness",name:"HomeStar Services & Contracting",description:`Expert home remodeling in ${hood.name}, ${hood.city}, Indiana.`,url:"https://www.thehomestarservice.com",telephone:"+1-317-279-4798",areaServed:{"@type":"Place",name:`${hood.name}, ${hood.city}, IN`},aggregateRating:{"@type":"AggregateRating",ratingValue:"5.0",reviewCount:"78"}})}}/>
