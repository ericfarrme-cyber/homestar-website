...
const CITIES = {
  ...
  "home-remodeling-mccordsville-in": {
    ...
    deepContent: ["McCordsville is one of the fastest-growing communities in the Indianapolis area, with many newer homes in developments that share a border with Fishers and Geist. Because we've completed dozens of projects in those neighboring areas, we know the home styles, layouts, and expectations in McCordsville intimately.","Most McCordsville homes are newer builds with full basements and modern layouts, which makes them excellent candidates for basement finishing and updates that add both living space and value. McCordsville families most often come to us for entertainment-focused basements, master bathroom upgrades, and kitchen remodels.","Every McCordsville project is built by licensed tradespeople with Schluter Pro Certified waterproofing, backed by our 25-year waterproofing warranty and 1-year workmanship warranty, with direct owner involvement from Eric and Robb throughout."],
    services: ["Bathroom Remodeling","Basement Finishing","Kitchen Remodeling","Flooring Services","Painting Services","Decks & Outdoor Living"],
    projects: [],
    faq: [
